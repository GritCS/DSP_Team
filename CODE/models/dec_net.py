...
class DecNet(nn.Module):
    def __init__(self, heads, final_kernel, head_conv, channels,channel):
        ...
        # c_low, c_up
        self.dec_c2 = CombinationModule(channels[-3], channels[-4], batch_norm=True)
        self.dec_c3 = CombinationModule(channels[-2], channels[-3], batch_norm=True)
        self.dec_c4 = CombinationModule(channels[-1], channels[-2], batch_norm=True)
        self.heads = heads
